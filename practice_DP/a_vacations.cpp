...
void solve(){
    ...
    for(int i = 0; i<n; i++)
    {
        if(a[i] == 1 && prevState != 1) prevState = 1;
        else if(a[i] == 2 && prevState != 2) prevState = 2;
        else if(a[i] == 3 && prevState == 1) prevState = 2;
        else if(a[i] == 3 && prevState == 2) prevState = 1;
        else if(a[i] == 3 && prevState == 0) prevState = 0;
        else {
            rest++;
            prevState = 0;
        } 
